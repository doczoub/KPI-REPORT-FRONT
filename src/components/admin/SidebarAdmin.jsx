...
const SidebarAdmin = () => {
    ...
    return (
      <>
        ...
        md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl bg-[#121127] flex flex-wrap items-center
         justify-between relative md:w-64 z-10 py-4 px-6">
          <div className="md:flex-col md:items-stretch md:min-h-full 
          md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
            {/* Toggler */}
            <button
...
{/*   
            ...
            <NavLink
              ...
              activeClassName="text-white"
            >
              <i className="fas fa-solid fa-square-root-variable text-white pr-2"></i>
              <span className="flex-1 md:min-w-full text-white text-xs uppercase font-bold block pt-4 pb-4 no-underline">
              ...
              <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
                <li className="items-center">
                  <Link
                    ...
                    to="#"
                  >
                    <i className="fas fa-arrow-right-to-bracket text-blueGray-400 mr-2 text-sm"></i>{" "}
                    Deconnexion
                  </Link>
                </li>
